...
public class ListIterator {
	...
	private ParentLink current;
	private ParentLink previous;
	private ParentList ourList;
	
	public ListIterator(ParentList list) {
		ourList = list;
	...
	public void insertBefore(String dData) {//insert before the current link
		ParentLink newLink = new ParentLink(dData);
